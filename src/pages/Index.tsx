            ...
            <Tabs value={activeTab} onValueChange={(value) => setActiveTab(value as any)}>
              ...
              {viewMode === "mobile" ? (
                ...
                <div className="mb-6 relative">
                  {/* Gradiente Esquerdo */}
                  {showLeftArrow && (
                    <div className="absolute left-0 top-0 bottom-0 w-12 bg-gradient-to-r from-background to-transparent z-10 pointer-events-none gradient-fade" />
                  )}
                  ...
                  {showLeftArrow && (
                    <Button
                      ...
                      className="absolute left-2 top-1/2 -translate-y-1/2 z-20 h-8 w-8 rounded-full shadow-md"
                    >
                  ...
                  >
                    <TabsList className="inline-flex w-auto h-12 p-1.5 glass-effect gap-1.5">
                      {Object.entries(tabConfig).map(([key, config]) => {
                        const TabIcon = config.icon;
                        return (
                          <TabsTrigger 
                            key={key}
                            value={key}
                            className="flex-shrink-0 min-w-[140px] h-9 flex items-center justify-center gap-2 px-4
                  ...
                  {/* Gradiente Direito */}
                  {showRightArrow && (
                    <div className="absolute right-0 top-0 bottom-0 w-12 bg-gradient-to-l from-background to-transparent z-10 pointer-events-none gradient-fade" />
                  )}
                  ...
                  {showRightArrow && (
                    <Button
                      ...
                      className="absolute right-2 top-1/2 -translate-y-1/2 z-20 h-8 w-8 rounded-full shadow-md"
                    >
